...
@Component({
  selector: 'app-dialog-salaire',
  templateUrl: './dialog-salaire.component.html',
  styleUrls: ['./dialog-salaire.component.scss']
})
export class DialogSalaireComponent implements OnInit {
